...
#+RESULTS:
:results:
: /opt/miniconda3/envs/mrg/lib/python3.7/site-packages/ipykernel_launcher.py:9: UserWarning: Matplotlib is currently using module://matplotlib_inline.backend_inline, which is a non-GUI backend, so cannot show the figure.
:   if __name__ == '__main__':
#+attr_org: :width 685
[[file:./.ob-jupyter/abc0fb650fc2d453496e50a2608ebfec3caf800b.png]]
:end:
